        ...
        {showLogo && (
          <Link to="/" className="flex-1 flex flex-col items-center">
            ...
            <img 
              ...
              alt="Leederville" 
              className="h-3 md:h-4 w-auto mt-0.5"
            />
          </Link>
        )}

        {/* Follow Us with Social Icons */}
        <div className="flex items-center gap-1.5 absolute right-4 top-4">
          <span 
            className={[
              "text-xs font-blur tracking-wide mr-1",
              showFollowLabel === 'always' ? 'inline' : 'hidden sm:inline',
            ].join(' ')}
            style={{ color: '#E59D50' }}
          >
            Follow Us
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="#E59D50">
